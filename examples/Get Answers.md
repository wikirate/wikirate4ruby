...
_Wikirate platform helps users to find and research answers to specific questions (metrics) about companies.  
Each answer is described by a metric, company, value, year, and source._

This example assumes you have configured your Wikirate REST `client`. Instructions on how to configure a client can be
found in [examples/Configuration.md](https://github.com/wikirate/wikirate4ruby/blob/main/examples/Configuration.md).
...
- **_company_**: returns all metric answers of the defined company given its identifier.
- **_company_keyword:_** returns all metric answers of companies that contain in their name the given string
- **_metric_**: returns all metric answers of the defined metric given its identifier.
- **_metric_keyword:_** returns all metric answers of metrics that contain in their name the given string
- **_company_category:_** returns all metric answers of companies that belong to a given company category. Available
  company categories. Allowed parameter values:
    ...
    - 'O': Other
- **_topic_framework_**: returns all metric answers that have been tagged with the given topic framework. All wikirate
  topic frameworks can be found [here](https://wikirate.org/Topic_Frameworks).
- **_topic_**: returns all metric answers that have been tagged with the given topic. All wikirate
  topic frameworks can be found [here](https://wikirate.org/Topics).
...
Instead of specifying `metric_name` and `metric_designer`, you can directly pass a
